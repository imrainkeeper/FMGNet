...
class net14_local(nn.Module):
    def __init__(self, load_weights=True):
        super(net14_local, self).__init__()
        ...
        self.trunk_backend3_3 = nn.Sequential(nn.Conv2d(512, 256, kernel_size=3, padding=4, stride=1, dilation=4),
                                              nn.ReLU(inplace=True))
        self.density_map_layer = nn.Conv2d(768, 1, kernel_size=1)
    ...
    def forward(self, x):
        ...
        x_trunk_output = self.density_map_layer(x_trunk3)
