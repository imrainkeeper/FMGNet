...
class net10_local(nn.Module):
    def __init__(self, load_weights=True):
        ...
        self.auxiliary_backend_feat = ['M', 512, 512, 512, 'M', 512, 512]
        self.auxiliary_backend = make_layers(self.auxiliary_backend_feat, in_channels=512, dilation=False)
        self.auxiliary_backend_output_layer = nn.Conv2d(512, 1, kernel_size=1)
    ...
    def forward(self, x):
        ...
        x_trunk = x_share * x_auxiliary_mask_feature         # 每个channel都做一个mask
